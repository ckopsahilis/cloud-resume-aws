...
## Files
- `main.tf`: The massive heart of the infrastructure. Provisions the Static S3 bucket, DynamoDB table, Lambda zip packaging & function loading, API Gateway with HTTP proxy paths, and bucket public access policies.
